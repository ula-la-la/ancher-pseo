  ...
  return <main><SiteHeader />
    <div className="detail wrap">
      ...
      <section className="detail-hero">
        ...
        <a className="primary-button wide" href={signupUrl}>Create this template <span>→</span></a><p className="draft-note"><b>Preview pending.</b> The finished Ancher example will be added before this page is indexed.</p></div>
      </section>
